 ...
 * x Create method to get nearest category // Yes but now were changing to locationId so go back to tiled and plug that through
 * x Add helper methods to AchievementsInterface
 * x Update Achievements typedef to include rewards
 ...
 * x Achievement UI panel
 * - Mayor NPCs // Osaik becomes Fiewon mayor, Baroness becomes Hyrill mayor, need a NPC for Bodiam mayor
 * x Talk to mayor/guildsmater to claim all rewards for their achievements if any
 * \ Call the steps
 */
