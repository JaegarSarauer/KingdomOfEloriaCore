...
const Model = {
    ...
    BABY_DRAGON: {
        ...
        HEAD: {
            ...
            spriteID: 1,
            anchor: {x: 0.85, y: 0.85},
            position: {x: -0.4, y: -0.08},
            rotation: 0,
            UIModel: null,
        },
        LEG_VISIBLE_FRONT: {
            id: 'LEG_VISIBLE_FRONT',
            asset: 'legParts',
            parent: 'CHEST',
            spriteID: 1,
            anchor: {x: 0.5, y: 0.1},
            position: {x: -0.25, y: 0.175},
            rotation: 0.0,
            UIModel: null,
        },
        LEG_VISIBLE_BACK: {
        ...
        TAIL_TIP: {
            ...
            spriteID: 1,
            anchor: {x: 3/6, y: 7/9 },
            position: {x: 4/8, y: -5/10 },
            rotation: 0,
            UIModel: null,
        },
    },
    ADOLESCENT_DRAGON: {
        id: 'ADOLESCENT_DRAGON',
        CORE: {
            id: 'CORE',
            asset: 'chestParts',
            parent: null,
        ...
        TAIL_BASE: {
            ...
            parent: 'CHEST',
            spriteID: 1,
            anchor: {x: 2/24, y: 7/15 },
            position: {x: 0.42, y: 0.15},
            rotation: 0.0,
            UIModel: null,
        },
        TAIL_MIDDLE: {
...
const AnimationsClaim = {
    HUMANOID : {
        WALK_HORIZONTAL : ['LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_THIGH', 'RIGHT_SHIN', 'CHEST'],
        WALK_VERTICAL : ['LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_THIGH', 'RIGHT_SHIN', 'CHEST'],
        RUN_HORIZONTAL : ['LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_THIGH', 'RIGHT_SHIN', 'CHEST'],
        RUN_VERTICAL : ['LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_THIGH', 'RIGHT_SHIN', 'CHEST'],
        ATTACK_MELEE : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        ATTACK_WEAPON : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        ATTACK_RANGE : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        ATTACK_MAGIC : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        ...
        MINE : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM', 'CHEST'],
        ...
        DEATH_TUTORIAL: ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM', 'CHEST', 'RIGHT_THIGH', 'LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_SHIN'],
        PET : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        PICKUP : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM', 'CHEST', 'RIGHT_THIGH', 'LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_SHIN'],
        ...
        EAT: ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
        TELEPORT: ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM', 'CHEST', 'RIGHT_THIGH', 'LEFT_THIGH', 'LEFT_SHIN', 'RIGHT_SHIN'],
        TELEPORT_OTHER : ['LEFT_SHOULDER', 'LEFT_FOREARM', 'RIGHT_SHOULDER', 'RIGHT_FOREARM'],
    },
    FOUR_LEGGED_MAMMAL : {
                ...
                if (key.bone ) {
                    ...
                    if (key.bone) {
                        ...
                        if (bone.angle != null) {
                           ...
                           //let spin = key.spin == -1 ? -1 : 1;
                           //console.info(key.spin, spin)
                           //let baseAngle = 360 * spin;
                           //baseAngle += angle;
...
module.exports.buildModelPart = buildModelPart = (oldPartDef, newPartDef) => {
    ...
    let result = {
        ...
        rotation: newPartDef.rotation != null ? (newPartDef.rotation) : (oldPartDef.rotation != null ? oldPartDef.rotation : 0),
        spriteID: newPartDef.spriteID != null ? (newPartDef.spriteID) : (oldPartDef.spriteID != null ? oldPartDef.spriteID : 0),
        UIModel: newPartDef.UIModel || oldPartDef.UIModel || null,
        z : newPartDef.z != null ? (newPartDef.z) : (oldPartDef.z != null ? oldPartDef.z : 0),
