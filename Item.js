...
const Item = Object.freeze([
    ...
    Get.Item.CosmeticHat(943, 31, 'Sheriff Hat', 'A hat that should come with a moustache', 627 ),
    Get.Item.CosmeticHat(944, 32, 'Detective Hat', 'A hat for special operatives', 628 ),
    ...
    Get.Item.CosmeticHat(951, 39, 'Jester Hat', 'A novice jester hat', 635 ),
    Get.Item.CosmeticHat(952, 40, 'Jester Hat', 'A hat for the confused jester', 636),
    Get.Item.CosmeticHat(953, 41, 'Jester Hat', 'A jester hat thats sure to make anyone laugh ', 637 ),
    Get.Item.CosmeticHat(954, 42, 'Jester Hat', 'A magical jester hat, just try not to laugh', 638 ),
    ...
    Get.Item.CosmeticShirt(957, 45, 'Jester Shirt', 'Why is this shirt happier than me', 641 ),
    Get.Item.CosmeticShirt(958, 46, 'Jester Shirt', 'A shirt packed with jester magic', 642 ),
    ...
    Get.Item.CosmeticHat(965, 53, 'Hustler Hat', 'Attract unwanted attention in this hat', 649 ),
    Get.Item.CosmeticHat(966, 54, 'Hustler Hat', 'A hat made for the Boss.', 650 ),
    ...
    Get.Item.CosmeticHat(975, 63, 'Blindfold', 'A raggedy blindfold', 659 ),
    Get.Item.CosmeticHat(976, 64, 'Blindfold', 'A shredded piece of silk cloth', 660),
    Get.Item.CosmeticHat(977, 65, 'Blindfold', 'Pure as bloodied snow', 661 ),
    Get.Item.CosmeticHat(978, 66, 'Eyepatch', 'Your skill in combat saved one eye at least', 662 ),
    ...
    Get.Item.CosmeticHat(987, 75, 'Friendly Fire', 'A novice mistake', 671 ),
    Get.Item.CosmeticHat(988, 76, 'Friendly Fire', 'A training accident', 672 ),
    Get.Item.CosmeticHat(989, 77, 'Friendly Fire', 'A battlefield mishap', 673 ),
    Get.Item.CosmeticHat(990, 78, 'Friendly Fire', 'Tis but a scratch', 674 ),
    Get.Item.CosmeticHat(991, 79, 'Friendly Fire', 'A flesh wound', 675 ),
    Get.Item.CosmeticHat(992, 80, 'Friendly Fire', 'Some say its lucky', 676 ),
    ...
    Get.Item.CosmeticHat(997, 85, 'Scholar Hat', 'An apprentice scholar hat', 681 ),
    Get.Item.CosmeticHat(998, 86, 'Scholar Hat', 'A quality hat for a scholar', 682 ),
    Get.Item.CosmeticHat(999, 87, 'Scholar Hat', 'A hat for a learned scholar', 683 ),
    Get.Item.CosmeticHat(1000, 88, 'Scholar Hat', 'A hat signifying grand wisdom', 684 ),
    Get.Item.CosmeticHat(1001, 89, 'Scholar Hat', 'A hat made for the wisest in the land', 685 ),
    ...
    Get.Item.CosmeticHat(1007, 95, 'Fox Face', 'A cute fox', 691 ),
    Get.Item.CosmeticHat(1008, 96, 'Fox Face', 'A brown fox', 692 ),
    Get.Item.CosmeticHat(1009, 97, 'Fox Face', 'A snow fox', 693 ),
    Get.Item.CosmeticHat(1010, 98, 'Fox Face', 'A sly fox', 694 ),
    Get.Item.CosmeticHat(1011, 99, 'Fox Face', 'A magical fox', 695 ),
    Get.Item.CosmeticHat(1012, 100, 'Fox Face', 'Foxy Cleopatra', 696 ),
    Get.Item.CosmeticHat(1013, 101, 'Top Hat', 'A basic top hat for a basic fellow', 697 ),
    Get.Item.CosmeticHat(1014, 102, 'Top Hat', 'A basic top hat with a little extra', 698 ),
    Get.Item.CosmeticHat(1015, 103, 'Top Hat', 'A basic top hat for a regular fellow', 699 ),
    Get.Item.CosmeticHat(1016, 104, 'Top Hat', 'A quality top hat for a quality individual', 700 ),
    Get.Item.CosmeticHat(1017, 105, 'Top Hat', 'A top quality top hat with a monocle', 701 ),
    Get.Item.CosmeticHat(1018, 106, 'Top Hat', 'Only the priveleged have even set eyes upon this hat', 702 ),
    Get.Item.CosmeticHat(1019, 107, 'Ski Hat', 'Low light conditions', 703 ),
    Get.Item.CosmeticHat(1020, 108, 'Ski Hat', 'Where is the snow', 704 ),
    Get.Item.CosmeticHat(1021, 109, 'Ski Hat', 'Sponsored rider', 705 ),
    ...
    Get.Item.CosmeticSunglasses(1027, 115, 'O Frames', 'Think your eyes are too big?', 711 ),
    Get.Item.CosmeticSunglasses(1028, 116, 'O Frames', 'Prove that time travel is possible with these', 712 ),
    Get.Item.CosmeticSunglasses(1029, 117, 'Daft Visor', 'Rock some robots with this visor', 713 ),
    Get.Item.CosmeticSunglasses(1030, 118, 'Teller Brim', 'All I see is green', 714 ),
    ...
    Get.Item.CosmeticSunglasses(1036, 124, 'Monocle', 'Look like an oil baron', 720 ),
    Get.Item.CosmeticSunglasses(1037, 125, 'Monocle', 'Look like a cyborg oil baron', 721 ),
    ...
    Get.Item.CosmeticSunglasses(1041, 129, 'Eye Patch', 'Cat got your eye?', 725 ),
    ...
    Get.Item.CosmeticHat(1044, 132, 'Coconut Hat', 'Protection from falling coconuts', 728 ),
    ...
    Get.Item.CosmeticHat(1048, 136, 'Octopus Hat', 'A blueraspberry infused octopus', 732 ),
    Get.Item.CosmeticHat(1049, 137, 'Octopus Hat', 'An octopus so crazy on screen, it became mystical', 733 ),
    Get.Item.CosmeticHat(1050, 138, 'Octopus Hat', 'A jeweled ocotpus, the best kind', 734 ),
]);
