...
const Item = Object.freeze([
    ...
    Get.Item.GemRing(801, 'Opal Ring', 5, 15, 58, 1, ItemStates.ENCHANTED_GEM.build(-1, 0), 521),
    Get.Item.GemRing(802, 'Topaz Ring', 10, 20, 66, 2, ItemStates.ENCHANTED_GEM.build(-1, 0), 522),
    Get.Item.GemRing(803, 'Quartz Ring', 15, 25, 74, 3, ItemStates.ENCHANTED_GEM.build(-1, 0), 523),
    Get.Item.GemRing(804, 'Jade Ring', 20, 30, 87, 4, ItemStates.ENCHANTED_GEM.build(-1, 0), 524),
    Get.Item.GemRing(805, 'Amber Ring', 25, 35, 96, 5, ItemStates.ENCHANTED_GEM.build(-1, 0), 525),
    Get.Item.GemRing(806, 'Sapphire Ring', 30, 40, 114, 6, ItemStates.ENCHANTED_GEM.build(-1, 0), 526),
    Get.Item.GemRing(807, 'Amethyst Ring', 37, 45, 139, 7, ItemStates.ENCHANTED_GEM.build(-1, 0), 527),
    Get.Item.GemRing(808, 'Emerald Ring', 45, 50, 196, 8, ItemStates.ENCHANTED_GEM.build(-1, 0), 528),
    Get.Item.GemRing(809, 'Ruby Ring', 55, 55, 258, 9, ItemStates.ENCHANTED_GEM.build(-1, 0), 529),
    Get.Item.GemRing(810, 'Onyx Ring', 67, 60, 298, 10, ItemStates.ENCHANTED_GEM.build(-1, 0), 530),
    Get.Item.GemRing(811, 'Diamond Ring', 80, 65, 423, 11, ItemStates.ENCHANTED_GEM.build(-1, 0), 531),
    Get.Item.Mold(812, 813, 'Ring Mold', 2, 532, 'A mold to form a ring in.', EssenceValue(4, 1, [ShardCatalog.EARTH(8)])),
    Get.Item.Note(813, 812, 'Ring Mold', 2, 532),
    Get.Item.Mold(814, 815, 'Amulet Mold', 3, 533, 'A mold to form an amulet in.', EssenceValue(4, 1, [ShardCatalog.EARTH(8)])),
    Get.Item.Note(815, 814, 'Amulet Mold', 3, 533),
