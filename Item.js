...
const Item = Object.freeze([
    ...
    Get.Item.CosmeticHat(976, 65, 'Hat 24', 'Special hat 24', 661 ),
    Get.Item.CosmeticHat(977, 66, 'Hat 25', 'Special hat 25', 662 ),
    Get.Item.CosmeticShirt(978, 67, 'Shirt 22', 'Special Shirt 22', 663 ),
    Get.Item.CosmeticShirt(979, 68, 'Shirt 23', 'Special Shirt 23', 664 ),
    Get.Item.CosmeticShirt(980, 69, 'Shirt 24', 'Special Shirt 24', 665 ),
    Get.Item.CosmeticShirt(981, 70, 'Shirt 25', 'Special Shirt 25', 666 ),
    Get.Item.CosmeticPants(982, 71, 'Pants 22', 'Special Pants 22', 667 ),
    Get.Item.CosmeticPants(983, 72, 'Pants 23', 'Special Pants 23', 668 ),
    Get.Item.CosmeticPants(984, 73, 'Pants 24', 'Special Pants 24', 669 ),
    Get.Item.CosmeticPants(985, 74, 'Pants 25', 'Special Pants 25', 670 ),
    Get.Item.CosmeticHat(986, 75, 'Hat 26', 'Dagger in head 1', 671 ),
    Get.Item.CosmeticHat(987, 76, 'Hat 27', 'Dagger in head 2', 672 ),
    Get.Item.CosmeticHat(988, 77, 'Hat 28', 'Dagger in head 3', 673 ),
    Get.Item.CosmeticHat(989, 78, 'Hat 29', 'Dagger in head 4', 674 ),
    Get.Item.CosmeticHat(990, 79, 'Hat 30', 'Dagger in head 5', 675 ),
    Get.Item.CosmeticHat(991, 80, 'Hat 31', 'Dagger in head 6', 676 ),
    Get.Item.CosmeticHat(992, 81, 'Hat 32', 'Arrow in head 1', 677 ),
    Get.Item.CosmeticHat(993, 82, 'Hat 33', 'Arrow in head 2', 678 ),
    Get.Item.CosmeticHat(994, 83, 'Hat 34', 'Arrow in head 3', 679 ),
    Get.Item.CosmeticHat(995, 84, 'Hat 35', 'Arrow in head 4', 680 ),
    Get.Item.CosmeticHat(996, 85, 'Hat 36', 'Monacle hat 1', 681 ),
    Get.Item.CosmeticHat(997, 86, 'Hat 37', 'Monacle hat 2', 682 ),
    Get.Item.CosmeticHat(998, 87, 'Hat 38', 'Monacle hat 3', 683 ),
    Get.Item.CosmeticHat(999, 88, 'Hat 39', 'Monacle hat 4', 684 ),
    Get.Item.CosmeticHat(1000, 89, 'Hat 40', 'Monacle hat 5', 685 ),
    Get.Item.CosmeticHat(1001, 90, 'Hat 41', 'Frog 1', 686 ),
    Get.Item.CosmeticHat(1002, 91, 'Hat 42', 'Frog 2', 687 ),
    Get.Item.CosmeticHat(1003, 92, 'Hat 43', 'Frog 3', 688 ),
    Get.Item.CosmeticHat(1004, 93, 'Hat 44', 'Frog 4', 689 ),
    Get.Item.CosmeticHat(1005, 94, 'Hat 45', 'Frog 5', 690 ),
    Get.Item.CosmeticHat(1006, 95, 'Hat 46', 'Fox 1', 691 ),
    Get.Item.CosmeticHat(1007, 96, 'Hat 47', 'Fox 2', 692 ),
    Get.Item.CosmeticHat(1008, 97, 'Hat 48', 'Fox 3', 693 ),
    Get.Item.CosmeticHat(1009, 98, 'Hat 49', 'Fox 4', 694 ),
    Get.Item.CosmeticHat(1010, 99, 'Hat 50', 'Fox 5', 695 ),
    Get.Item.CosmeticHat(1011, 100, 'Hat 51', 'Fox 6', 696 ),
    Get.Item.CosmeticHat(1012, 101, 'Hat 52', 'Top hat 1', 697 ),
    Get.Item.CosmeticHat(1013, 102, 'Hat 53', 'Top hat 2', 698 ),
    Get.Item.CosmeticHat(1014, 103, 'Hat 54', 'Top hat 3', 699 ),
    Get.Item.CosmeticHat(1015, 104, 'Hat 55', 'Top hat 4', 700 ),
    Get.Item.CosmeticHat(1016, 105, 'Hat 56', 'Top hat 5', 701 ),
    Get.Item.CosmeticHat(1017, 106, 'Hat 57', 'Top hat 6', 702 ),
    Get.Item.CosmeticHat(1018, 107, 'Hat 58', 'Ski hat 1', 700 ),
    Get.Item.CosmeticHat(1019, 108, 'Hat 59', 'Ski hat 2', 701 ),
    Get.Item.CosmeticHat(1020, 109, 'Hat 60', 'Ski hat 3', 702 ),
    Get.Item.CosmeticSunglasses(1021, 110, 'Sunglasses 1', 'Heart sunglasses', 703 ),
    Get.Item.CosmeticSunglasses(1022, 111, 'Sunglasses 2', 'Sunglasses ', 704 ),
    Get.Item.CosmeticSunglasses(1023, 112, 'Sunglasses 3', 'Sunglasses ', 705 ),
    Get.Item.CosmeticSunglasses(1024, 113, 'Sunglasses 4', 'Sunglasses ', 706 ),
    Get.Item.CosmeticSunglasses(1025, 114, 'Sunglasses 5', 'Sunglasses ', 707 ),
    Get.Item.CosmeticSunglasses(1026, 115, 'Sunglasses 6', 'Sunglasses ', 708 ),
    Get.Item.CosmeticSunglasses(1027, 116, 'Sunglasses 7', 'Sunglasses ', 709 ),
    Get.Item.CosmeticSunglasses(1028, 117, 'Sunglasses 8', 'Visor ', 710 ),
    Get.Item.CosmeticSunglasses(1029, 118, 'Sunglasses 9', 'Geen Visor ', 711 ),
    Get.Item.CosmeticSunglasses(1030, 119, 'Sunglasses 10', 'Visor', 712 ),
    Get.Item.CosmeticSunglasses(1031, 120, 'Sunglasses 11', 'Visor', 713 ),
    Get.Item.CosmeticSunglasses(1032, 121, 'Sunglasses 12', 'Sunglasses ', 714 ),
    Get.Item.CosmeticSunglasses(1033, 122, 'Sunglasses 13', 'Sunglasses ', 715 ),
    Get.Item.CosmeticSunglasses(1034, 123, 'Sunglasses 14', 'Sunglasses ', 716 ),
    Get.Item.CosmeticSunglasses(1035, 124, 'Sunglasses 15', 'Monacle', 717 ),
    Get.Item.CosmeticSunglasses(1036, 125, 'Sunglasses 16', 'Evil Monacle', 718 ),
    Get.Item.CosmeticSunglasses(1037, 126, 'Sunglasses 17', 'Sunglasses ', 719 ),
    Get.Item.CosmeticSunglasses(1038, 127, 'Sunglasses 18', 'Sunglasses ', 720 ),
    Get.Item.CosmeticSunglasses(1039, 128, 'Sunglasses 19', 'Sunglasses ', 721 ),
    Get.Item.CosmeticSunglasses(1040, 129, 'Sunglasses 20', 'Eye Patch', 722 ),
    Get.Item.CosmeticSunglasses(1041, 130, 'Sunglasses 21', 'Blue Visor', 723 ),
    Get.Item.CosmeticHat(1042, 131, 'Hat 61', 'Crab hat', 724 ),
    Get.Item.CosmeticHat(1043, 132, 'Hat 62', 'Coconut hat', 725 ),
    Get.Item.CosmeticHat(1044, 133, 'Hat 63', 'Octopus hat 1', 726 ),
    Get.Item.CosmeticHat(1045, 134, 'Hat 64', 'Octopus hat 2', 727 ),
    Get.Item.CosmeticHat(1046, 135, 'Hat 65', 'Octopus hat 3', 728 ),
    Get.Item.CosmeticHat(1047, 136, 'Hat 66', 'Octopus hat 4', 729 ),
    Get.Item.CosmeticHat(1048, 137, 'Hat 67', 'Octopus hat 5', 730 ),
    Get.Item.CosmeticHat(1049, 138, 'Hat 68', 'Octopus hat 6', 731 ),
]);
