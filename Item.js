...
const Item = Object.freeze([
    ...
    Get.Item.CosmeticPants(1054, 142, 'Pants', 'A pair of pants', 738 ),
    Get.Item.CosmeticPants(1055, 143, 'Pants', 'A pair of pants', 739 ),
    Get.Item.CosmeticPants(1056, 144, 'Pants', 'A pair of pants', 740 ),
    Get.Item.CosmeticShirt(1057, 135, 'Shirt', 'A shirt', 741 ),
    Get.Item.CosmeticShirt(1058, 146, 'Shirt', 'A shirt', 742 ),
    Get.Item.CosmeticShirt(1059, 147, 'Shirt', 'A shirt', 743 ),
    Get.Item.CosmeticPants(1060, 148, 'Pants', 'A pair of pants', 744 ),
    Get.Item.CosmeticPants(1061, 149, 'Pants', 'A pair of pants', 745 ),
    Get.Item.CosmeticPants(1062, 150, 'Pants', 'A pair of pants', 746 ),
    Get.Item.CosmeticShirt(1063, 151, 'Shirt', 'A shirt', 747 ),
    Get.Item.CosmeticShirt(1064, 152, 'Shirt', 'A shirt', 748 ),
    Get.Item.CosmeticShirt(1065, 153, 'Shirt', 'A shirt', 749 ),
    Get.Item.CosmeticShirt(1066, 154, 'Shirt', 'A shirt', 750 ),
    Get.Item.CosmeticShirt(1067, 155, 'Shirt', 'A shirt', 751 ),
    Get.Item.CosmeticShirt(1068, 156, 'Shirt', 'A shirt', 752 ),
    Get.Item.CosmeticShirt(1069, 157, 'Shirt', 'A shirt', 753 ),
    Get.Item.CosmeticShirt(1070, 158, 'Shirt', 'A shirt', 754 ),
    Get.Item.CosmeticShirt(1071, 159, 'Shirt', 'A shirt', 755 ),
