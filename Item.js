...
const Item = Object.freeze([
    ...
    Get.Item.CosmeticShirt(920, 8, 'Shirt 4', 'Special Shirt 4', 604 ),
    Get.Item.CosmeticShirt(921, 9, 'Shirt 5', 'Special Shirt 5', 605 ),
    Get.Item.CosmeticPants(922, 10, 'Pants 1', 'Special Pants 1', 606 ),
    Get.Item.CosmeticPants(923, 11, 'Pants 2', 'Special Pants 2', 607 ),
    ...
    Get.Item.CosmeticShirt(935, 23, 'Shirt 9', 'Special Shirt 9', 619 ),
    Get.Item.CosmeticShirt(936, 24, 'Shirt 10', 'Special Shirt 10', 620 ),
    Get.Item.CosmeticPants(937, 25, 'Pants 6', 'Special Pants 6', 621 ),
    Get.Item.CosmeticPants(938, 26, 'Pants 7', 'Special Pants 7', 622 ),
    Get.Item.CosmeticPants(939, 27, 'Pants 8', 'Special Pants 8', 623 ),
    Get.Item.CosmeticPants(940, 28, 'Pants 9', 'Special Pants 9', 624 ),
    Get.Item.CosmeticPants(941, 29, 'Pants 10', 'Special Pants 10', 625 ),
    Get.Item.CosmeticHat(942, 30, 'Hat 11', 'Special hat 11', 626 ),
    Get.Item.CosmeticHat(943, 31, 'Hat 12', 'Special hat 12', 627 ),
    Get.Item.CosmeticHat(944, 32, 'Hat 13', 'Special hat 13', 628 ),
    Get.Item.CosmeticShirt(945, 33, 'Shirt 11', 'Special Shirt 11', 629 ),
    Get.Item.CosmeticShirt(946, 34, 'Shirt 12', 'Special Shirt 12', 630 ),
    Get.Item.CosmeticShirt(947, 35, 'Shirt 13', 'Special Shirt 13', 631 ),
    Get.Item.CosmeticPants(948, 36, 'Pants 11', 'Special Pants 11', 632 ),
    Get.Item.CosmeticPants(949, 37, 'Pants 12', 'Special Pants 12', 633 ),
    Get.Item.CosmeticPants(950, 38, 'Pants 13', 'Special Pants 13', 634 ),
    Get.Item.CosmeticHat(951, 39, 'Hat 14', 'Special hat 14', 635 ),
    Get.Item.CosmeticHat(952, 40, 'Hat 15', 'Special hat 15', 636),
    Get.Item.CosmeticHat(953, 41, 'Hat 16', 'Special hat 16', 637 ),
    Get.Item.CosmeticHat(954, 42, 'Hat 17', 'Special hat 17', 638 ),
    Get.Item.CosmeticShirt(955, 43, 'Shirt 14', 'Special Shirt 14', 639 ),
    Get.Item.CosmeticShirt(956, 44, 'Shirt 16', 'Special Shirt 15', 640 ),
    Get.Item.CosmeticShirt(957, 45, 'Shirt 16', 'Special Shirt 16', 641 ),
    Get.Item.CosmeticShirt(958, 46, 'Shirt 17', 'Special Shirt 17', 642 ),
    Get.Item.CosmeticPants(959, 47, 'Pants 14', 'Special Pants 14', 643 ),
    Get.Item.CosmeticPants(960, 48, 'Pants 15', 'Special Pants 15', 644 ),
    Get.Item.CosmeticPants(961, 49, 'Pants 16', 'Special Pants 16', 645 ),
    Get.Item.CosmeticPants(962, 50, 'Pants 17', 'Special Pants 17', 646 ),
    Get.Item.CosmeticHat(963, 51, 'Hat 18', 'Special hat 18', 647 ),
    Get.Item.CosmeticHat(964, 52, 'Hat 19', 'Special hat 19', 648),
    Get.Item.CosmeticHat(965, 53, 'Hat 20', 'Special hat 20', 649 ),
    Get.Item.CosmeticHat(966, 54, 'Hat 21', 'Special hat 21', 650 ),
    Get.Item.CosmeticShirt(967, 55, 'Shirt 18', 'Special Shirt 18', 651 ),
    Get.Item.CosmeticShirt(968, 56, 'Shirt 19', 'Special Shirt 19', 652 ),
    Get.Item.CosmeticShirt(969, 57, 'Shirt 20', 'Special Shirt 20', 653 ),
    Get.Item.CosmeticShirt(970, 58, 'Shirt 21', 'Special Shirt 21', 654 ),
    Get.Item.CosmeticPants(971, 59, 'Pants 18', 'Special Pants 18', 655 ),
    Get.Item.CosmeticPants(972, 60, 'Pants 19', 'Special Pants 19', 656 ),
    Get.Item.CosmeticPants(973, 61, 'Pants 20', 'Special Pants 20', 657 ),
    Get.Item.CosmeticPants(974, 62, 'Pants 21', 'Special Pants 21', 658 ),
    Get.Item.CosmeticHat(975, 63, 'Hat 22', 'Special hat 22', 659 ),
    Get.Item.CosmeticHat(976, 64, 'Hat 23', 'Special hat 23', 660),
    Get.Item.CosmeticHat(977, 65, 'Hat 24', 'Special hat 24', 661 ),
    Get.Item.CosmeticHat(978, 66, 'Hat 25', 'Special hat 25', 662 ),
    Get.Item.CosmeticShirt(979, 67, 'Shirt 22', 'Special Shirt 22', 663 ),
    Get.Item.CosmeticShirt(980, 68, 'Shirt 23', 'Special Shirt 23', 664 ),
    Get.Item.CosmeticShirt(981, 69, 'Shirt 24', 'Special Shirt 24', 665 ),
    Get.Item.CosmeticShirt(982, 70, 'Shirt 25', 'Special Shirt 25', 666 ),
    Get.Item.CosmeticPants(983, 71, 'Pants 22', 'Special Pants 22', 667 ),
    Get.Item.CosmeticPants(984, 72, 'Pants 23', 'Special Pants 23', 668 ),
    Get.Item.CosmeticPants(985, 73, 'Pants 24', 'Special Pants 24', 669 ),
    Get.Item.CosmeticPants(986, 74, 'Pants 25', 'Special Pants 25', 670 ),
    Get.Item.CosmeticHat(987, 75, 'Hat 26', 'Dagger in head 1', 671 ),
    Get.Item.CosmeticHat(988, 76, 'Hat 27', 'Dagger in head 2', 672 ),
    Get.Item.CosmeticHat(989, 77, 'Hat 28', 'Dagger in head 3', 673 ),
    Get.Item.CosmeticHat(990, 78, 'Hat 29', 'Dagger in head 4', 674 ),
    Get.Item.CosmeticHat(991, 79, 'Hat 30', 'Dagger in head 5', 675 ),
    Get.Item.CosmeticHat(992, 80, 'Hat 31', 'Dagger in head 6', 676 ),
    Get.Item.CosmeticHat(993, 81, 'Hat 32', 'Arrow in head 1', 677 ),
    Get.Item.CosmeticHat(994, 82, 'Hat 33', 'Arrow in head 2', 678 ),
    Get.Item.CosmeticHat(995, 83, 'Hat 34', 'Arrow in head 3', 679 ),
    Get.Item.CosmeticHat(996, 84, 'Hat 35', 'Arrow in head 4', 680 ),
    Get.Item.CosmeticHat(997, 85, 'Hat 36', 'Monacle hat 1', 681 ),
    Get.Item.CosmeticHat(998, 86, 'Hat 37', 'Monacle hat 2', 682 ),
    Get.Item.CosmeticHat(999, 87, 'Hat 38', 'Monacle hat 3', 683 ),
    Get.Item.CosmeticHat(1000, 88, 'Hat 39', 'Monacle hat 4', 684 ),
    Get.Item.CosmeticHat(1001, 89, 'Hat 40', 'Monacle hat 5', 685 ),
    Get.Item.CosmeticHat(1002, 90, 'Hat 41', 'Frog 1', 686 ),
    Get.Item.CosmeticHat(1003, 91, 'Hat 42', 'Frog 2', 687 ),
    Get.Item.CosmeticHat(1004, 92, 'Hat 43', 'Frog 3', 688 ),
    Get.Item.CosmeticHat(1005, 93, 'Hat 44', 'Frog 4', 689 ),
    Get.Item.CosmeticHat(1006, 94, 'Hat 45', 'Frog 5', 690 ),
    Get.Item.CosmeticHat(1007, 95, 'Hat 46', 'Fox 1', 691 ),
    Get.Item.CosmeticHat(1008, 96, 'Hat 47', 'Fox 2', 692 ),
    Get.Item.CosmeticHat(1009, 97, 'Hat 48', 'Fox 3', 693 ),
    Get.Item.CosmeticHat(1010, 98, 'Hat 49', 'Fox 4', 694 ),
    Get.Item.CosmeticHat(1011, 99, 'Hat 50', 'Fox 5', 695 ),
    Get.Item.CosmeticHat(1012, 100, 'Hat 51', 'Fox 6', 696 ),
    Get.Item.CosmeticHat(1013, 101, 'Hat 52', 'Top hat 1', 697 ),
    Get.Item.CosmeticHat(1014, 102, 'Hat 53', 'Top hat 2', 698 ),
    Get.Item.CosmeticHat(1015, 103, 'Hat 54', 'Top hat 3', 699 ),
    Get.Item.CosmeticHat(1016, 104, 'Hat 55', 'Top hat 4', 700 ),
    Get.Item.CosmeticHat(1017, 105, 'Hat 56', 'Top hat 5', 701 ),
    Get.Item.CosmeticHat(1018, 106, 'Hat 57', 'Top hat 6', 702 ),
    Get.Item.CosmeticHat(1019, 107, 'Hat 58', 'Ski hat 1', 700 ),
    Get.Item.CosmeticHat(1020, 108, 'Hat 59', 'Ski hat 2', 701 ),
    Get.Item.CosmeticHat(1021, 109, 'Hat 60', 'Ski hat 3', 702 ),
    Get.Item.CosmeticSunglasses(1022, 110, 'Sunglasses 1', 'Heart sunglasses', 703 ),
    Get.Item.CosmeticSunglasses(1023, 111, 'Sunglasses 2', 'Sunglasses ', 704 ),
    Get.Item.CosmeticSunglasses(1024, 112, 'Sunglasses 3', 'Sunglasses ', 705 ),
    Get.Item.CosmeticSunglasses(1025, 113, 'Sunglasses 4', 'Sunglasses ', 706 ),
    Get.Item.CosmeticSunglasses(1026, 114, 'Sunglasses 5', 'Sunglasses ', 707 ),
    Get.Item.CosmeticSunglasses(1027, 115, 'Sunglasses 6', 'Sunglasses ', 708 ),
    Get.Item.CosmeticSunglasses(1028, 116, 'Sunglasses 7', 'Sunglasses ', 709 ),
    Get.Item.CosmeticSunglasses(1029, 117, 'Sunglasses 8', 'Visor ', 710 ),
    Get.Item.CosmeticSunglasses(1030, 118, 'Sunglasses 9', 'Geen Visor ', 711 ),
    Get.Item.CosmeticSunglasses(1031, 119, 'Sunglasses 10', 'Visor', 712 ),
    Get.Item.CosmeticSunglasses(1032, 120, 'Sunglasses 11', 'Visor', 713 ),
    Get.Item.CosmeticSunglasses(1033, 121, 'Sunglasses 12', 'Sunglasses ', 714 ),
    Get.Item.CosmeticSunglasses(1034, 122, 'Sunglasses 13', 'Sunglasses ', 715 ),
    Get.Item.CosmeticSunglasses(1035, 123, 'Sunglasses 14', 'Sunglasses ', 716 ),
    Get.Item.CosmeticSunglasses(1036, 124, 'Sunglasses 15', 'Monacle', 717 ),
    Get.Item.CosmeticSunglasses(1037, 125, 'Sunglasses 16', 'Evil Monacle', 718 ),
    Get.Item.CosmeticSunglasses(1038, 126, 'Sunglasses 17', 'Sunglasses ', 719 ),
    Get.Item.CosmeticSunglasses(1039, 127, 'Sunglasses 18', 'Sunglasses ', 720 ),
    Get.Item.CosmeticSunglasses(1040, 128, 'Sunglasses 19', 'Sunglasses ', 721 ),
    Get.Item.CosmeticSunglasses(1041, 129, 'Sunglasses 20', 'Eye Patch', 722 ),
    Get.Item.CosmeticSunglasses(1042, 130, 'Sunglasses 21', 'Blue Visor', 723 ),
    Get.Item.CosmeticHat(1043, 131, 'Hat 61', 'Crab hat', 724 ),
    Get.Item.CosmeticHat(1044, 132, 'Hat 62', 'Coconut hat', 725 ),
    Get.Item.CosmeticHat(1045, 133, 'Hat 63', 'Octopus hat 1', 726 ),
    Get.Item.CosmeticHat(1046, 134, 'Hat 64', 'Octopus hat 2', 727 ),
    Get.Item.CosmeticHat(1047, 135, 'Hat 65', 'Octopus hat 3', 728 ),
    Get.Item.CosmeticHat(1048, 136, 'Hat 66', 'Octopus hat 4', 729 ),
    Get.Item.CosmeticHat(1049, 137, 'Hat 67', 'Octopus hat 5', 730 ),
    Get.Item.CosmeticHat(1050, 138, 'Hat 68', 'Octopus hat 6', 731 ),
]);
