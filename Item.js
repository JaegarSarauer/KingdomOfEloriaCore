...
const Item = Object.freeze([
    ...
    Get.Item.SpellUnlockScroll(687, 'Lesser Air Wound', 0, 24, 444, 32, [ShardCatalog.NATURE(12), ShardCatalog.AIR(180)]),
    Get.Item.SpellUnlockScroll(688, 'Lesser Water Wound', 1, 35, 445, 34, [ShardCatalog.NATURE(12), ShardCatalog.WATER(180)]),
    Get.Item.SpellUnlockScroll(689, 'Lesser Earth Wound', 2, 41, 446, 36, [ShardCatalog.NATURE(12), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(690, 'Lesser Fire Wound', 3, 48, 447, 38, [ShardCatalog.NATURE(12), ShardCatalog.FIRE(180)]),
    Get.Item.SpellUnlockScroll(691, 'Lesser Metal Wound', 4, 59, 448, 40, [ShardCatalog.NATURE(12), ShardCatalog.METAL(180)]),
    Get.Item.SpellUnlockScroll(692, 'Air Wound', 5, 119, 449, 32, [ShardCatalog.NATURE(18), ShardCatalog.AIR(280)]),
    Get.Item.SpellUnlockScroll(693, 'Water Wound', 6, 121, 450, 34, [ShardCatalog.NATURE(18), ShardCatalog.WATER(280)]),
    Get.Item.SpellUnlockScroll(694, 'Earth Wound', 7, 142, 451, 36, [ShardCatalog.NATURE(18), ShardCatalog.EARTH(280)]),
    Get.Item.SpellUnlockScroll(695, 'Fire Wound', 8, 159, 452, 38, [ShardCatalog.NATURE(18), ShardCatalog.FIRE(280)]),
    Get.Item.SpellUnlockScroll(696, 'Metal Wound', 9, 177, 453, 40, [ShardCatalog.NATURE(18), ShardCatalog.METAL(280)]),
    Get.Item.SpellUnlockScroll(697, 'Greater Air Wound', 10, 231, 454, 32, [ShardCatalog.NATURE(25), ShardCatalog.AIR(380)]),
    Get.Item.SpellUnlockScroll(698, 'Greater Water Wound', 11, 242, 455, 34, [ShardCatalog.NATURE(25), ShardCatalog.WATER(380)]),
    Get.Item.SpellUnlockScroll(699, 'Greater Earth Wound', 12, 276, 456, 36, [ShardCatalog.NATURE(25), ShardCatalog.EARTH(380)]),
    Get.Item.SpellUnlockScroll(700, 'Greater Fire Wound', 13, 289, 457, 38, [ShardCatalog.NATURE(25), ShardCatalog.FIRE(380)]),
    Get.Item.SpellUnlockScroll(701, 'Greater Metal Wound', 14, 330, 458, 40, [ShardCatalog.NATURE(25), ShardCatalog.METAL(380)]),
    ...
    Get.Item.SpellUnlockScroll(715, 'Fiewon Teleport', 15, 512, 472, 32, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(716, 'Cadgwith Teleport', 16, 672, 473, 36, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(717, 'Volcano Teleport', 17, 755, 474, 40, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(718, 'Island Teleport', 18, 525, 475, 44, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(719, 'Hyrill Teleport', 19, 742, 476, 48, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(720, 'Bodiam Teleport', 20, 523, 477, 52, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(721, 'Woodcutting Guild Teleport', 21, 843, 478, 56, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(722, 'Mining Guild Teleport', 22, 941, 479, 60, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    ...
    Get.Item.RawCoockableFood(900, 901, 'Raw Crab', 22, 564, 'A raw crab, tastes better cooked.', 30, EssenceValue(4, 2, [ShardCatalog.EARTH(10), ShardCatalog.NATURE(5)]), false), // Jaegar look at last 3 params
    Get.Item.Note(901, 900, 'Raw Crab', 22, 564),
    Get.Item.Food(902, 903, 'Crab', 50, 6, 565, 'A well cooked crab.', EssenceValue(6, 2, [ShardCatalog.EARTH(10), ShardCatalog.NATURE(5)]), false), // Jaegar look at last 3 params
    Get.Item.Note(903, 902, 'Crab', 50, 565),
