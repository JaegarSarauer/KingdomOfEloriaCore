...
const Item = Object.freeze([
    ...
    {
        id: 564,
        name: 'Obelisk Teleport Scroll',
        noted: false,
        value: 14,
        stackable: true,
        description: 'A teleport scroll to the obelisk minigame.',
        ...
        actions: [{
            ...
            id: 17,
            steps: [
                [buildStep(StepType.SEND_CLIENT_MESSAGE, { params: ['You rip the scroll into pieces...'] }),
    ...
    Get.Item.Amulet(676, 'Opal Amulet', 1, 15, 60, 1, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 433),
    Get.Item.Amulet(677, 'Topaz Amulet', 1, 20, 68, 2, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 434),
    Get.Item.Amulet(678, 'Quartz Amulet', 10, 25, 77, 3, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 435),
    Get.Item.Amulet(679, 'Jade Amulet', 20, 30, 90, 4, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 436),
    Get.Item.Amulet(680, 'Amber Amulet', 30, 35, 99, 5, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 437),
    Get.Item.Amulet(681, 'Sapphire Amulet', 40, 40, 118, 6, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 438),
    Get.Item.Amulet(682, 'Amethyst Amulet', 50, 45, 145, 7, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 439),
    Get.Item.Amulet(683, 'Emerald Amulet', 60, 50, 203, 8, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 440),
    Get.Item.Amulet(684, 'Ruby Amulet', 70, 55, 267, 9, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 441),
    Get.Item.Amulet(685, 'Onyx Amulet', 80, 60, 312, 10, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 442),
    Get.Item.Amulet(686, 'Diamond Amulet', 90, 65, 458, 11, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 443),
    ...
    Get.Item.SpellUnlockScroll(690, 'Lesser Fire Wound Scroll', 3, 48, 447, 38, [ShardCatalog.NATURE(12), ShardCatalog.FIRE(180)]),
    Get.Item.SpellUnlockScroll(691, 'Lesser Metal Wound Scroll', 4, 59, 448, 40, [ShardCatalog.NATURE(12), ShardCatalog.METAL(180)]),
    Get.Item.SpellUnlockScroll(692, 'Air Wound Scroll', 5, 119, 449, 32, [ShardCatalog.NATURE(18), ShardCatalog.AIR(280)]),
    Get.Item.SpellUnlockScroll(693, 'Water Wound Scroll', 6, 121, 450, 34, [ShardCatalog.NATURE(18), ShardCatalog.WATER(280)]),
    Get.Item.SpellUnlockScroll(694, 'Earth Wound Scroll', 7, 142, 451, 36, [ShardCatalog.NATURE(18), ShardCatalog.EARTH(280)]),
    Get.Item.SpellUnlockScroll(695, 'Fire Wound Scroll', 8, 159, 452, 38, [ShardCatalog.NATURE(18), ShardCatalog.FIRE(280)]),
    Get.Item.SpellUnlockScroll(696, 'Metal Wound Scroll', 9, 177, 453, 40, [ShardCatalog.NATURE(18), ShardCatalog.METAL(280)]),
    Get.Item.SpellUnlockScroll(697, 'Greater Air Wound Scroll', 10, 231, 454, 32, [ShardCatalog.NATURE(25), ShardCatalog.AIR(380)]),
    Get.Item.SpellUnlockScroll(698, 'Greater Water Wound Scroll', 11, 242, 455, 34, [ShardCatalog.NATURE(25), ShardCatalog.WATER(380)]),
    Get.Item.SpellUnlockScroll(699, 'Greater Earth Wound Scroll', 12, 276, 456, 36, [ShardCatalog.NATURE(25), ShardCatalog.EARTH(380)]),
    Get.Item.SpellUnlockScroll(700, 'Greater Fire Wound Scroll', 13, 289, 457, 38, [ShardCatalog.NATURE(25), ShardCatalog.FIRE(380)]),
    Get.Item.SpellUnlockScroll(701, 'Greater Metal Wound Scroll', 14, 330, 458, 40, [ShardCatalog.NATURE(25), ShardCatalog.METAL(380)]),
    Get.Item.SpellPot(702, 'Lesser Metal Wound', 4, 18, 8, 8, 58, [ShardCatalog.AIR(195), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.METAL(90), ShardCatalog.FIRE(5), ShardCatalog.FORCE(10)], 459, 5),
    Get.Item.SpellPot(703, 'Air Wound', 5, 26, 10, 10, 60, [ShardCatalog.AIR(295), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.FIRE(5), ShardCatalog.FORCE(20)], 460, 6),
    Get.Item.SpellPot(704, 'Water Wound', 5, 30, 12, 12, 62, [ShardCatalog.AIR(195), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.WATER(190), ShardCatalog.FIRE(5), ShardCatalog.FORCE(20)], 461, 6),
    Get.Item.SpellPot(705, 'Earth Wound', 5, 34, 14, 14, 64, [ShardCatalog.AIR(195), ShardCatalog.EARTH(204), ShardCatalog.NATURE(1), ShardCatalog.FIRE(5), ShardCatalog.FORCE(20)], 462, 6),
    Get.Item.SpellPot(706, 'Fire Wound', 5, 38, 16, 16, 66, [ShardCatalog.AIR(195), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.FIRE(195), ShardCatalog.FORCE(20)], 463, 6),
    Get.Item.SpellPot(707, 'Metal Wound', 5, 42, 18, 18, 68, [ShardCatalog.AIR(195), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.METAL(190), ShardCatalog.FIRE(5), ShardCatalog.FORCE(20)], 464, 6),
    Get.Item.SpellPot(708, 'Greater Air Wound', 5, 54, 20, 20, 70, [ShardCatalog.AIR(395), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.FIRE(5), ShardCatalog.FORCE(30)], 465, 6),
    Get.Item.SpellPot(709, 'Greater Water Wound', 5, 58, 22, 22, 72, [ShardCatalog.AIR(295), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.WATER(285), ShardCatalog.FIRE(5), ShardCatalog.FORCE(30)], 466, 6),
    Get.Item.SpellPot(710, 'Greater Earth Wound', 5, 62, 24, 24, 74, [ShardCatalog.AIR(295), ShardCatalog.EARTH(299), ShardCatalog.NATURE(1), ShardCatalog.FIRE(5), ShardCatalog.FORCE(30)], 467, 6),
    Get.Item.SpellPot(711, 'Greater Fire Wound', 5, 66, 26, 26, 76, [ShardCatalog.AIR(295), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.FIRE(290), ShardCatalog.FORCE(30)], 468, 6),
    Get.Item.SpellPot(712, 'Greater Metal Wound', 5, 70, 28, 28, 78, [ShardCatalog.AIR(295), ShardCatalog.EARTH(14), ShardCatalog.NATURE(1), ShardCatalog.METAL(285), ShardCatalog.FIRE(5), ShardCatalog.FORCE(30)], 469, 6),
    ...
    Get.Item.SpellUnlockScroll(715, 'Fiewon Teleport Scroll', 15, 512, 472, 32, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(716, 'Cadgwith Teleport Scroll', 16, 672, 473, 36, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(717, 'Volcano Teleport Scroll', 17, 755, 474, 40, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(718, 'Island Teleport Scroll', 18, 525, 475, 44, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(719, 'Hyrill Teleport Scroll', 19, 742, 476, 48, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(720, 'Bodiam Teleport Scroll', 20, 523, 477, 52, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(721, 'Woodcutting Guild Teleport Scroll', 21, 843, 478, 56, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.SpellUnlockScroll(722, 'Mining Guild Teleport Scroll', 22, 941, 479, 60, [ShardCatalog.NATURE(20), ShardCatalog.EARTH(180)]),
    Get.Item.Shirt(723, 724, 'Pre-Alpha Shirt', 480, 'shirtVersionMilestone', 1, 15, 'In commemoration of players who played in pre-alpha' ),
    Get.Item.Note(724, 723, 'Pre-Alpha Shirt', 5, 480),
    Get.Item.Shirt(725, 726, 'Alpha Shirt', 481, 'shirtVersionMilestone', 2, 15, 'In commemoration of players who played in alpha' ),
    Get.Item.Note(726, 725, 'Alpha Shirt', 5, 481),
    Get.Item.SpellUnlockScroll(727, '3x3 Item Pickup', 23, 550, 484, 45, [ShardCatalog.BIND(120), ShardCatalog.AIR(180)]),
    Get.Item.SpellUnlockScroll(728, '5x5 Item Pickup', 24, 1850, 485, 55, [ShardCatalog.BIND(220), ShardCatalog.AIR(380)]),
    ...
    Get.Item.GemRing(801, 'Opal Ring', 5, 15, 58, 1, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 523),
    Get.Item.GemRing(802, 'Topaz Ring', 10, 20, 66, 2, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 524),
    Get.Item.GemRing(803, 'Quartz Ring', 15, 25, 74, 3, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 525),
    Get.Item.GemRing(804, 'Jade Ring', 20, 30, 87, 4, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 526),
    Get.Item.GemRing(805, 'Amber Ring', 25, 35, 96, 5, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 527),
    Get.Item.GemRing(806, 'Sapphire Ring', 30, 40, 114, 6, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 528),
    Get.Item.GemRing(807, 'Amethyst Ring', 37, 45, 139, 7, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 529),
    Get.Item.GemRing(808, 'Emerald Ring', 45, 50, 196, 8, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 530),
    Get.Item.GemRing(809, 'Ruby Ring', 55, 55, 258, 9, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 531),
    Get.Item.GemRing(810, 'Onyx Ring', 67, 60, 298, 10, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 532),
    Get.Item.GemRing(811, 'Diamond Ring', 80, 65, 423, 11, ItemStates.ENCHANTED_GEM.build(0, 10, 0), 533),
    Get.Item.Mold(812, 813, 'Ring Mold', 2, 520, 'A mold to form a ring in.', EssenceValue(4, 1, [ShardCatalog.EARTH(8)])),
    Get.Item.Note(813, 812, 'Ring Mold', 2, 520),
    Get.Item.Mold(814, 815, 'Amulet Mold', 3, 521, 'A mold to form an amulet in.', EssenceValue(4, 1, [ShardCatalog.EARTH(8)])),
    Get.Item.Note(815, 814, 'Amulet Mold', 3, 521),
    ...
    // Get.Item.Note(614, 613, "Red Dye", 8, 299),
    // Get.Item.Dye(615, 616, "Orange Dye", 8, 300, SpriteColor.Orange),
    // Get.Item.Note(616, 615, "Orange Dye", 8, 300),
    // Get.Item.Dye(617, 618, "Yellow Dye", 8, 301, SpriteColor.Yellow),
    // Get.Item.Note(618, 617, "Yellow Dye", 8, 301),
    // Get.Item.Dye(619, 620, "Green Dye", 8, 302, SpriteColor.Green),
    // Get.Item.Note(620, 619, "Green Dye", 8, 302),
    // Get.Item.Dye(621, 622, "Blue Dye", 8, 303, SpriteColor.Blue),
    // Get.Item.Note(622, 621, "Blue Dye", 8, 303),
    // Get.Item.Dye(623, 624, "Purple Dye", 8, 304, SpriteColor.Purple),
    // Get.Item.Note(624, 623, "Purple Dye", 8, 304),
    // Get.Item.Dye(625, 626, "Gray Dye", 8, 305, SpriteColor.DarkGray),
    // Get.Item.Note(626, 625, "Gray Dye", 8, 305),
    // Get.Item.Dye(627, 628, "White Dye", 8, 306, SpriteColor.LightGray),
    // Get.Item.Note(628, 627, "White Dye", 8, 306),
    // Get.Item.Dye(629, 630, "Black Dye", 8, 307, SpriteColor.Black),
    // Get.Item.Note(630, 629, "Black Dye", 8, 307),
]);
