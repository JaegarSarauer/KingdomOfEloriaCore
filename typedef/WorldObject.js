...
module.exports.WorldObject = WorldObject = [
    ...
    Get.WorldObject.Rock(4, 'Copper Rock', 1, [10, 15, 4, true, 0.5, 0.5], [[55, 1, 1, 100]], 25, 1, 8, 4, 'There appears to be copper in this rock.', 572, 575), 
    Get.WorldObject.Rock(5, 'Iron Rock', 10, [10, 20, 5, true, 0.5, 0.5], [[56, 1, 1, 100]], 50, 2, 16, 6, 'There appears to be iron in this rock.', 578, 581), 
    Get.WorldObject.Rock(6, 'Coal Rock', 20, [10, 25, 6, true, 0.5, 0.5], [[57, 1, 1, 100]], 75, 3, 24, 8, 'There appears to be coal in this rock.', 584, 587), 
    Get.WorldObject.Rock(7, 'Nelenite Rock', 30, [10, 30, 7, true, 0.5, 0.5], [[58, 1, 1, 100]], 100, 4, 32, 10, 'There appears to be nelenite in this rock.', 590, 593),  
    {
        id: 8,
        name: 'Fire',
    ...
    Get.WorldObject.Rock(47, 'Gothite Rock', 40, [10, 35, 8, true, 0.5, 0.5], [[253, 1, 1, 100]], 125, 5, 40, 12, 'A rock with hints of gothite ore.', 596, 599), 
    Get.WorldObject.Rock(48, 'Osmium Rock', 50, [10, 40, 9, true, 0.5, 0.5], [[281, 1, 1, 100]], 150, 6, 48, 14, 'A rock with veins of osmium metal.', 602, 605),
    ...
    Get.WorldObject.Rock(80, 'Gold Rock', 25, [10, 32, 7, true, 0.5, 0.5], [[670, 1, 1, 100]], 85, 8, 120, 10, 'There appears to be gold in this rock.'),
    ...
    Get.WorldObject.Rock(83, 'Pure Coal Rock', 40, [10, 30, 3, true, 0.33, 0.33], [[57, 1, 1, 90], [57, 1, 2, 10]], 75, 3, 50, 20, 'There appears to be extra coal in this rock.', 584, 587), 
