...
Get.Character.GoblinOrcRanged(18, 'Orc', 1,  
    ...
    [[[1, 100], [0, 20, 45, 70], [38, 1, 1, 19], [39, 1, 1, 1], [127, 1, 1, 5], [168, 1, 1, 5]], [[1, 100], [68, 3, 12, 50], [69, 2, 7, 40], [70, 1, 4, 10]], [[512, 1], [636, 1, 1, 1]], Get.DropTables.ItemPickupPages(128)], //80% chance for coins, 20% chance for copper dagger, and 1 in 10 chance for water essence or blue cloth //[ [[chance to roll table, table roll size (min to max chance to roll)], [id, min, max, weight], ...] [table2...] ]
    39, 8, 2), // Attack range
Get.Character.GoblinOrOrc(19, 'King Orc', 3,  
    ...
    [[[1, 100], [0, 50, 150, 100]], [[1, 100], [89, 1, 2, 50], [90, 1, 2, 50]], [[10, 100], [79, 5, 20, 50], [30, 1, 1, 5], [127, 1, 1, 15], [26, 1, 1, 15], [19, 1, 1, 15]], [[128, 1], [636, 1, 1, 1]], Get.DropTables.TeleportScrolls(256), Get.DropTables.ItemPickupPages(80)], //80% chance for coins, 20% chance for copper dagger, and 1 in 10 chance for water essence or blue cloth //[ [[chance to roll table, table roll size (min to max chance to roll)], [id, min, max, weight], ...] [table2...] ]
    19, 4), // head sprite ID
Get.Character.GoblinOrcMage(20, 'Elder Goblin', 1,  
    ...
    [[[1, 100], [0, 10, 30, 100]], [[8, 100], [89, 1, 1, 55], [90, 1, 1, 45]], [[10, 100], [127, 1, 1, 25], [126, 1, 1, 35], [79, 5, 10, 10], [78, 5, 10, 10], [80, 5, 10, 10], [81, 5, 10, 10]], [[256, 1], [636, 1, 1, 1]], Get.DropTables.TeleportScrolls(400), Get.DropTables.ItemPickupPages(100)], //80% chance for coins, 20% chance for copper dagger, and 1 in 10 chance for water essence or blue cloth //[ [[chance to roll table, table roll size (min to max chance to roll)], [id, min, max, weight], ...] [table2...] ]
...
Get.Character.GoblinOrcMage(21, 'Elder Goblin', 1,  
    ...
    [[[1, 100], [0, 15, 35, 100]], [[8, 100], [89, 1, 1, 45], [90, 1, 1, 55]], [[10, 100], [127, 1, 1, 35], [126, 1, 1, 25], [79, 5, 10, 10], [78, 5, 10, 10], [80, 5, 10, 10], [81, 5, 10, 10]], [[256, 1], [636, 1, 1, 1]], Get.DropTables.TeleportScrolls(400), Get.DropTables.ItemPickupPages(100)], //80% chance for coins, 20% chance for copper dagger, and 1 in 10 chance for water essence or blue cloth //[ [[chance to roll table, table roll size (min to max chance to roll)], [id, min, max, weight], ...] [table2...] ]
    ...
    [[[1, 100], [0, 45, 80, 100]]]),
{
    ...
    drops: [[[1, 200], [0, 20, 50, 80], [15, 1, 1, 20]], [[10, 100], [53, 1, 2, 90], [54, 1, 2, 10]], [[64, 1], [636, 1, 1, 1]], Get.DropTables.ItemPickupPages(128), Get.DropTables.TeleportScrolls(350)], //[ [[chance to roll table, table roll size (min to max chance to roll)], [id, min, max, weight], ...] [table2...] ]
