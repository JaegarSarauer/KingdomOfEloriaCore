...
const Interface = [
    ...
    {   
        ...
        actions: [
            ...
            {
                id: 282,
                name: 'Build Crab Pot (30 Construction) (3 Ash Logs, 2 Steel Bars)',
                flags: ['REPEAT_ACTION'],
                actionInterval: 6,
                steps: [
            ...
            Get.Interface.BuildFishingPool(293, 'Build Shallow Pool Fishery (10 Cons., 10 Fishing) (5 Logs, 1 Fishing Net)', 5, 10, 1, 20, 100, 'shallow pool fishery', 1096),
            Get.Interface.BuildLumberCamp(294, 'Build Lumber Camp (1 Construction, 10 Woodcutting) (5 Logs, 1 Copper Axe)', 5, 1, 10, 1, 16, 100, 'log lumber camp', 1097),
        ],
    },
    {
        id: 15,
