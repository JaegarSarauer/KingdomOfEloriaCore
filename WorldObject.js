...
module.exports.WorldObject = WorldObject = [
    ...
    Get.WorldObject.Flax(12),
    {
        ...
        actions: [{
            ...
            steps: [
                buildStepList(StepList.WALK_ADJACENT),
                [buildStep(StepType.PLAY_ANIMATION, { params: ['ACTION_BOTHHANDS'] }),
                buildStep(StepType.OPEN_ACTION_MENU_INTERFACE, { params: [[266, 60, 154, 281]] })]
            ],
        }],
        useActions: [],
        spriteIndex: 14,
    ...
    Get.WorldObject.DoorSkillLocked(95, 'Door', 1, 1, 1, null, 1, { x : 174, y : 70}, { x: 174, y: 69 }, 'Through the cracks you see a scary wolf. The Alpha Wolf.' ),
    Get.WorldObject.DoorSkillLocked(96, 'Door', 10, 35, 1, null, 0, { x : 65, y : 338}, { x: 65, y: 337 }, 'Through the door is a exclusive mining area.' ),
    ...
    Get.WorldObject.GemRock(104, 'Blue Gem', 1, 677, 87),
    Get.WorldObject.GemRock(105, 'Green Gem', 2, 677, 88),
    Get.WorldObject.GemRock(106, 'Purple Gem', 3, 677, 89),
    Get.WorldObject.GemRock(107, 'Burgunty Gem', 4, 677, 90),
    Get.WorldObject.GemRock(108, 'Red Gem', 5, 677, 537),
];